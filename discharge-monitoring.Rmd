...
# number the reps
# 
# result <- group_by(result, STW, SEASON, LOCATION_CODE, SAMPLE_NUMBER)
# data %>% group_indices(result, SAMPLE_NUMBER) 
# 
# result <- lapply(split(result, result$LOCATION_CODE), function(reps) {
#   
#   
#   reps <<- reps
#   stop(reps)
