...
knitr::opts_chunk$set(echo = F, comment = F,warning = F, cache = T, message = F)
```
...
library(DT)
group_by(result, LOCATION_CODE, LOCATION_DESCRIPTION.x, STW, SEASON, ANALYSIS_REPNAME) %>% summarize(COUNT = n()) %>%
  DT::datatable()
